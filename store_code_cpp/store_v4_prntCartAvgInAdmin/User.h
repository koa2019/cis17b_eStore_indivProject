...
#include <string> 
#include<iostream>
#include "Cart.h"    // Aggregating Cart Class
//#include "Survey.h"    // Aggregating Item Class
...
protected:
    ...
    int cartSiz;            // player's highest score
    
public:
    
    Cart cart; // Holds user's answer for each question    
    ...
    void setCartSiz(int s) { cartSiz = s; }
    void wrtCart();
    int getCartSiz() const {return cartSiz;}
